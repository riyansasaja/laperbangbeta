...
function indonesian_date ($timestamp = '', $date_format = 'l, j F Y | H:i:s', $suffix = 'WITA') {
    if (trim ($timestamp) == '')
    {
            $timestamp = time ();
    }
...
function indonesian_date_tanggal ($timestamp = '', $date_format = 'j F Y') {
    if (trim ($timestamp) == '')
    {
            $timestamp = time ();
    }
...
function indonesian_date_hari_tanggal ($timestamp = '', $date_format = 'l, j F Y') {
    if (trim ($timestamp) == '')
    {
            $timestamp = time ();
    }
...
function indonesian_date_hari ($timestamp = '', $date_format = 'l') {
    if (trim ($timestamp) == '')
    {
            $timestamp = time ();
    }
...
function indonesian_date_waktu ($timestamp = '', $date_format = 'H:i:s', $suffix = 'WITA') {
    if (trim ($timestamp) == '')
    {
            $timestamp = time ();
    }
