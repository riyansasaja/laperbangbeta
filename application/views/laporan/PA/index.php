          ...
          <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <!-- form start -->
                <form method="POST" action="<?php echo base_url('laporan/PA_laper/add_laporan_perkara'); ?>" enctype="multipart/form-data">
            ...
            <?php foreach ($laporan as $lhs) : ?>
              <tr>
                ...
                <td class="align-middle">
                  ...
                  <a href="<?= base_url('laporan/PA_laper/view_laporan/') . $lhs['id'] ?>" class="text-secondary font-weight-normal text-xs" data-toggle="tooltip" data-original-title="Lihat" title="Detail">
                    <i class="fa fa-eye"></i>
                  </a>
                </td>
              </tr>
